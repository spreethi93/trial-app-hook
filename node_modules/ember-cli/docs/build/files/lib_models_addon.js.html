...
let addonProto = {
  ...
  */
  treeForSrc(rawSrcTree) {
    ...
    if (isExperimentEnabled(&#x27;DELAYED_TRANSPILATION&#x27;) === false &amp;&amp; registryHasPreprocessor(this.registry, &#x27;template&#x27;)) {
  ...
  */
  ...
  _addonTemplateFiles(addonTree) {
    ...
    if (this._shouldCompilePodTemplates()) {
      let includePatterns = this.registry.extensionsForType(&#x27;template&#x27;).map(extension =&gt; &#x60;**/*/template.${extension}&#x60;);
