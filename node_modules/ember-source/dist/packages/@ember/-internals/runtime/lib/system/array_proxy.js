...
@module @ember/array
*/
import { get, objectAt, alias, PROPERTY_DID_CHANGE, addArrayObserver, removeArrayObserver, replace, getChainTagsForKey, CUSTOM_TAG_FOR, arrayContentDidChange, createTagForProperty } from '@ember/-internals/metal';
...
export default class ArrayProxy extends EmberObject {
  ...
  */
  ...
  _revalidate() {
    ...
    if (this._arrangedContentTag === null || !validate(this._arrangedContentTag, this._arrangedContentRevision)) {
