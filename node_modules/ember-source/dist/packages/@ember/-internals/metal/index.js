...
function addObserver$1(obj, path, target, method, sync = SYNC_DEFAULT) {
...
const PROPERTY_DID_CHANGE$1 = symbol('PROPERTY_DID_CHANGE');
let deferred = 0;
/**
...
function notifyPropertyChange(obj, keyName, _meta, value$$1) {
  ...
  if (PROPERTY_DID_CHANGE$1 in obj) {
    ...
    if (arguments.length === 4) {
      obj[PROPERTY_DID_CHANGE$1](keyName, value$$1);
    } else {
...
class ComputedProperty extends ComputedDescriptor {
  ...
  */
  ...
  set(obj, keyName, value$$1) {
    ...
    if (this._dependentKeys !== undefined && this._dependentKeys.length > 0 && // These two properties are set on Ember.Component
    typeof obj[PROPERTY_DID_CHANGE] === 'function' && obj.isComponent && // ensure that we only run this once, while the component is being instantiated
    meta(obj).isInitializing()) {
...
function updateObserversAndListeners(obj, key, fn, add) {
  ...
  if (observers !== undefined) {
    let updateObserver = add ? addObserver$1 : removeObserver;
