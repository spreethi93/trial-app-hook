...
export { symbol, isInternalSymbol, makeDictionary as dictionary, getDebugName$1 as getDebugName, getOwnPropertyDescriptors$1 as getOwnPropertyDescriptors, uuid, GUID_KEY, generateGuid, guidFor, intern, checkHasSuper, ROOT, wrap, getObservers, getListeners, setObservers, setListeners, inspect, lookupDescriptor, canInvoke, tryInvoke, makeArray, getName, setName, toString, HAS_NATIVE_SYMBOL, HAS_NATIVE_PROXY, isProxy, setProxy, Cache, EMBER_ARRAY, isEmberArray, setupMandatorySetter, teardownMandatorySetter, setWithMandatorySetter };
